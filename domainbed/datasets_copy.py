...
class ColoredMNIST(MultipleEnvironmentMNIST):
    ...
    def __init__(self, root, bias, test_envs, hparams):
        ...
        MY_COMBINE = [[2, True, 0, None, 11, True, False, 0], [2, True, 1, None, 12, True, False, 0],[2, True, bias, None, 13,  True, False, 0]]
    ...
    def color_dataset(self, images, labels, environment):
        ...
        for img_idx in range(total_len):
            ...
            if self.vis:
                ...
                if total_cnt == 20:
                    break
                #plt.imsave('test_{}.png'.format(img_idx), images[img_idx].numpy().transpose(1, 2, 0) / 255.)
        if self.vis:
...
class PlacesCOCO(MultipleEnvironmentCOCO):
    # random seed
    ENVIRONMENT_NAMES = [1, 2, 3]
    ...
    def __init__(self, root, bias, test_envs, hparams):
        ...
        # 1: use default places or random places (deprecated in PlacesCOCO);
        # 2: Bernoulli parameters for places;
        # 3: designated places number,
        # 4: random seed for digit colors
        # 5: Color places? 6: Color digit?
        # 7: Bernoulli parameters for bkgd colors
        # 8: removing data-augmentation or not
        MY_COMBINE = [[2, True, 0, None, 21, True,False, 0, True], [2, True, 0.9, None, 22,True,False, 0, False],[2, True, bias, None, 23, True,False, 0, False]]

        print("MY COMBINE:", MY_COMBINE)
        self.vis = False
        self.input_shape = (3, 64, 64,)
        self.num_classes = 10
        super(PlacesCOCO, self).__init__(MY_COMBINE, self.color_dataset, (3, 64, 64,), 10, True)
